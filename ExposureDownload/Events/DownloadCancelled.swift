...
extension Playback {
    internal struct DownloadCancelled: AnalyticsEvent {
        internal let eventType: String = "Playback.DownloadCancelled"
...
extension Playback.DownloadCancelled {
