...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/EricssonBroadcastServices/iOSClientExposure", from: "3.5.0"),
    ...
    targets: [
        ...
        .target(
            name: "iOSClientExposureDownload",
            dependencies: ["iOSClientDownload", "iOSClientExposure"], exclude: ["Info.plist"]),
        .target(
            name: "iOSClientExposureDownloadObjc",
            dependencies: []),
        .testTarget(
            name: "iOSClientExposureDownloadTests",
            dependencies: ["iOSClientExposureDownload", "iOSClientDownload","Quick", "Nimble"], exclude: ["Info.plist"]),
    ]
)
